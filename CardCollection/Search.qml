...
Item {
    ...
    // onSearchResults is a signal handler that is called when the search results are received
    Connections {
        target: backendController
...
// The following code is auto-generated by the Qt Quick Designer.
/*##^##
Designer {
